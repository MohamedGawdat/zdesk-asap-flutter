...
class MockZohodeskPortalConfigurationPlatform
  ...
  @override
  Future<void> setConfiguration(ZDPConfiguration configuration) async {}
...
void main() {
  final ZohodeskPortalConfigurationPlatform initialPlatform =
      ZohodeskPortalConfigurationPlatform.instance;

  test('$MethodChannelZohodeskPortalConfiguration is the default instance', () {
    expect(initialPlatform,
        isInstanceOf<MethodChannelZohodeskPortalConfiguration>());
  });
}
